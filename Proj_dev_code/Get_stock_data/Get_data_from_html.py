...
#=================================================================#
#=================================================================#
#個股月營收 cathaysec.moneydj.com/z/zc/zch/zchb_1220.djhtm   97~101
# http://cathaysec.moneydj.com/Z/ZC/ZCH/ZCH.DJHTM?A=2480 102~ IFRS
def company_monthly_revenue_report_no_merge  (company_number,company_name,date,basepath,folder_name):
    ...
    if not os.path.isfile("%s/%s_%s.csv"%(directory,company_number,company_name)):   #do when file not exit
        time.sleep(5) #wait 2 seconds
        Stock_page = urllib.request.urlopen('http://cathaysec.moneydj.com/Z/ZC/ZCH/ZCH.DJHTM?A=%s'%company_number)
...
#http://cathaysec.moneydj.com/Z/ZC/ZCR/ZCR.DJHTM?A=3311
def company_quarter_financial_ratio_sheet  (company_number,company_name,date,basepath,folder_name):
    directory = basepath+"/%s/%s/"%(date,folder_name)
    print(company_number)
    if not os.path.isfile("%s/%s_%s.csv"%(directory,company_number,company_name)):   #do when file not exit
        time.sleep(5) #wait 2 seconds
        Stock_page = urllib.request.urlopen('http://cathaysec.moneydj.com/Z/ZC/ZCR/ZCR.DJHTM?A=%s'%company_number)
        Stock_data = Stock_page.read().decode('big5','ignore')
        #print(Stock_data)
        get_formal_html_data(Stock_data)
...
#http://cathaysec.moneydj.com/z/zc/zcq/zcq_3311.djhtm
def company_quarter_income_statement_sheet  (company_number,company_name,date,basepath,folder_name):
    directory = basepath+"/%s/%s/"%(date,folder_name)
    print(company_number)
    if not os.path.isfile("%s/%s_%s.csv"%(directory,company_number,company_name)):   #do when file not exit
        time.sleep(5) #wait 2 seconds
        Stock_page = urllib.request.urlopen('http://cathaysec.moneydj.com/z/zc/zcq/zcq_%s.djhtm'%company_number)
        Stock_data = Stock_page.read().decode('big5','ignore')
        #print(Stock_data)
        get_formal_html_data(Stock_data)
...
#http://cathaysec.moneydj.com/z/zc/zcp/zcpa/zcpa_3311.djhtm
def company_balance_sheet  (company_number,company_name,date,basepath,folder_name):
    directory = basepath+"/%s/%s/"%(date,folder_name)
    print(company_number)
    if not os.path.isfile("%s/%s_%s.csv"%(directory,company_number,company_name)):   #do when file not exit
        time.sleep(5) #wait 2 seconds
        Stock_page = urllib.request.urlopen('http://cathaysec.moneydj.com/z/zc/zcp/zcpa/zcpa_%s.djhtm'%company_number)
        Stock_data = Stock_page.read().decode('big5','ignore')
        #print(Stock_data)
        get_formal_html_data(Stock_data)
...
# http://cathaysec.moneydj.com/z/zc/zc3/zc3_3311.djhtm
def company_cash_flow  (company_number,company_name,date,basepath,folder_name):
    directory = basepath+"/%s/%s/"%(date,folder_name)
    print(company_number)
    if not os.path.isfile("%s/%s_%s.csv"%(directory,company_number,company_name)):   #do when file not exit
        time.sleep(5) #wait 2 seconds
        Stock_page = urllib.request.urlopen('http://cathaysec.moneydj.com/z/zc/zc3/zc3_%s.djhtm'%company_number)
        Stock_data = Stock_page.read().decode('big5','ignore')
        #print(Stock_data)
        get_formal_html_data(Stock_data)
...
#=================================================================#
#=================================================================#
#每季營收，合併   http://cathaysec.moneydj.com/z/zc/zcd_%s.djhtm
def company_quarterly_revenue_report_no_merge (company_number,company_name,date,basepath,folder_name): 
    ...
    if not os.path.isfile("%s/%s_%s.csv"%(directory,company_number,company_name)):   #do when file not exit
        time.sleep(5) #wait 2 seconds
        # get html data
        Stock_page = urllib.request.urlopen('http://cathaysec.moneydj.com/z/zc/zcd_%s.djhtm'%company_number)  #number only
        Stock_data = Stock_page.read().decode('big5','ignore')
        #print (Stock_data)
